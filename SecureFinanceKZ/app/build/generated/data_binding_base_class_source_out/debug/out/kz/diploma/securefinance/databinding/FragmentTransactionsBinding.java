...
public final class FragmentTransactionsBinding implements ViewBinding {
  ...
  private FragmentTransactionsBinding(@NonNull LinearLayout rootView,
      @NonNull LinearLayout layoutEmptyState, @NonNull RecyclerView rvTransactions,
  ...
  public static FragmentTransactionsBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new FragmentTransactionsBinding((LinearLayout) rootView, layoutEmptyState,
          rvTransactions, searchView);
    }
