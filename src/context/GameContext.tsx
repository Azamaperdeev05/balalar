...
export const WORD_SEARCH_TASKS = [
  'Кім қызыл түсті бірдеңе бірінші болып табады?',
  'Кім дөңгелек пішінді затты бірінші болып табады?',
  'Кім өз киімінен әріпті бірінші болып табады?',
  'Кім саусақтарымен берілген санды тез көрсетеді?',
  '"Достық" сөзін тап.',
